...
from controller.camera_controller import start_camera,stop_camera,get_heatmap,get_video_feed,get_heatmap
...
camera_bp.route('/heatmap/<cam_id>', methods=["GET"])(get_heatmap)
